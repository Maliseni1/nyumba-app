...
import { FaCheck, FaCrown, FaShieldAlt, FaChartLine, FaUsers } from 'react-icons/fa';
...
const LandlordSubscriptionPage = () => {
    ...
    const handleSubscribe = (plan) => {
        if (!authUser) {
            ...
            navigate('/login', { state: { redirectTo: '/subscription/landlord' } });
            return;
        }
    ...
    return (
        <div className="pt-24 min-h-screen">
            <div className="relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-accent-color/10 to-purple-600/10"></div>
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                    <div className="text-center">
                        <h1 className="text-5xl font-bold text-text-color mb-6">
                            Landlord <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Pro</span>
                        </h1>
...
export default LandlordSubscriptionPage;