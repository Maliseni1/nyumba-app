...
    console.log("--- ListingFormPage: Attempting to render ---"); // Debug log
...
    useEffect(() => {
        console.log("--- ListingFormPage: Running useEffect ---");
        if (isEditMode) {
...
                {/* --- 6. IMAGE UPLOAD SECTION (DEBUGGING) --- */}
                <div>
...
                        </button>
                    )}
                    {/* --- DEBUG ACTION: Temporarily replacing ImageUpload ---
                        We are temporarily replacing the ImageUpload component with a standard file input
                        to check if the crash is originating from inside the ImageUpload component itself. 
                    */}
                    <div className="border border-dashed border-red-500 p-4 rounded-lg bg-red-50/10 text-red-500 text-center mb-2">
                        ImageUpload is temporarily disabled for troubleshooting.
                    </div>
